...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Show Evaluation'])
    <div class="container-fluid py-4">
        <div class="row mt-4">
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Show Evaluation</h6>
                    </div>
                    <div class="card-body p-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Matric ID</label>
                                    <p class="ms-1">{{ $data->user->matric_id }}</p>
                                </div>
                            </div>
